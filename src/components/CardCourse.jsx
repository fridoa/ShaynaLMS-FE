...
export default function CardCourse({ id = 1, name = "Mastering React", imageUrl = "/assets/images/thumbnails/th-3.png", totalStudent = "3,578 Students", category = "Programming" }) {
  return (
      ...
      <div className="w-full">
        ...
        <div className="flex items-center gap-5">
          <div className="flex items-center gap-[6px] mt-[6px]">
            ...
            <p className="text-[#838C9D]">{totalStudent}</p>
          </div>
          <div className="flex items-center gap-[6px] mt-[6px]">
