...
export default function CardCourse({ id = 1, title = "Responsive Design Triclorem Lorem, ipsum dolor.", imageUrl = "/assets/images/thumbnails/th-1.png", category = "Programming" }) {
  return (
