    ...
    <>
      <div className="card flex items-center gap-5">
        ...
        <div className="flex justify-end items-center gap-3">
          <Link href={`/manager/students/edit/${id}`} className="w-fit rounded-full border border-[#060A23] p-[14px_20px] font-semibold text-nowrap">
            Edit Profile
          </Link>
